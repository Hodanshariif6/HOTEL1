...
export default function Contact() {
  ...
  toast.success("cabashadada waa lagaga soo jawabi doona sacado kadib ✅");
...
<motion.form
  ...
  animate={{ opacity: 1, x: 0 }}
  transition={{ duration: 0.8 }}
  className="bg-white p-10 rounded-2xl shadow-2xl w-[113%] max-w-3xl mx-auto"
>
  ...
  <div className="mb-6 w-full">
    ...
    <div className="relative -ml-[60%] w-[150%]">
      ...
      <input
        ...
        className="text-black p-6 pl-12 h-14 -ml-50 mt-4  rounded-2xl shadow-sm 
                   focus:outline-none focus:ring-2 focus:ring-pink-400 
                   transition duration-300  text-lg hover:border-pink-400"
        required
      />
    </div>
  </div>
  ...
  <div className="mb-6">
    ...
    <div className="relative">
      ...
      <input
        ...
        onChange={handleChange}
        className="w-[400%]  text-black p-4  border border-gray-300 rounded-xl shadow-sm 
                   focus:outline-none focus:ring-2 focus:ring-pink-400 
  ...
  <div className="mb-8">
    ...
    <div className="relative -ml-72 ">
      ...
      <textarea
        ...
        onChange={handleChange}
        className="w-[170%] mt-80 p-4  border border-gray-300 rounded-xl shadow-sm 
                   focus:outline-none focus:ring-2 focus:ring-pink-400 
