...
function ForgotPassword() {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://hotel1-vp7d.onrender.com/forgot-password", { email });
  ...
  const handleResetSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://hotel1-vp7d.onrender.com/reset-password", { 
        token: token.trim(), 
        newPassword 
      });
